...
org-mode 支持内嵌 HTML 的功能，这样就让 blog 的作者决定能否编辑吧：
...
: 以上功能仅限本 blog 写权限成员使用，需要登录 github 账号。
: </p>
...
[fn:1] [[./201504-test_post/marisa_kuang.gif]] 自己截的 gif 图，图文可结合。\\
